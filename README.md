# 🤖 Guid for launching [TonOldy](https://t.me/TonOldy_bot/app?startapp=NjQzNDA1ODUyMQ==) bot

![img1](./images/tonoldy.png)
...
| **REF_LINK**                | <small>Your referral link in the format `'https://t.me/TonOldy_bot/app?startapp=NjQzNDA1ODUyMQ=='`</small>                      |
| **JOIN_TG_CHANNEL**         | <small>`True` or `False`</small>                                                      |
| **ADD_EMOJI**               | <small>`True` or `False`</small>                          |
...
## Step 1: Preparation
   ...
   * Download and extract the archive or use the command
     ...
     ```
     git clone https://github.com/duonanotte/TonOldy.git
     ```
